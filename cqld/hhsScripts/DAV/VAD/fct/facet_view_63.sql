--
--  $Id: facet_view.sql,v 1.106 2011/10/25 15:37:45 ghard Exp $
--
...
create procedure fct_page_head ()
{
  http ('<div id="hd_l">
    <h1 id="logo">
        <a href="/facet">
           <img src="/fct/images/logo_health.png" alt="Health.Data.Gov - Empowering People and Machines"/>
        </a>
    </h1>
    <div id="homelink"></div>
  </div> <!-- hd_l -->
  <div id="hd_r">
    <a href="http://health.data.gov/facet"
    title="Centers for MEDICARE & MEDICAID SERVICES">
    <img class="powered_by" src="/fct/images/cms_logo.png" alt="Centers for MEDICARE & MEDICAID SERVICES"/>
    </a>
  </div> 
<!--
<div id="hd_r">
