...
-- KDI serve up Linked Data on Virtuoso.
--
...
--
-- This file destroys and re-installs rewriting rules in the 
-- vocab.data.gov interface for the following contexts:
--    /sparql
--    /fct
--    /describe
--    /rdfs
...
--    http://download.openlinksw.com/packages/6.2/virtuoso/fct_dav.vad
--
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- ***************************************************** 
-- Rules for the vocab.data.gov interface
-- *****************************************************
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
-- /DAV
-- 
-- Access to webDAV in the vocab.data.gov interface
--
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DB.DBA.VHOST_REMOVE (
	 lhost=>'*ini*',
	 vhost=>'vocab.data.gov',
	 lpath=>'/DAV'
);
...
--
-- /dataset 
--              Rewrite Rules in the vocab.data.gov interface
--
-- Anything that ends in .html is sent to the facet browser for rendering.
-- Other filename extensions include:
--    .n3, .ttl, .json, .csv, .rdf, .txt, .atom, and .ajson
...
-- /facet
-- 
-- Access the facet browser in the vocab.data.gov interface
--
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DB.DBA.VHOST_REMOVE (
	 lhost=>'*ini*',
...
-- /facet/service
-- 
-- Access the facet web service in the vocab.data.gov interface
--
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DB.DBA.VHOST_REMOVE (
	 lhost=>'*ini*',
...
-- /search
-- 
-- Access the sparql processor in the vocab.data.gov interface
-- This is equivalent to /fct (search just seems like a better name)
--
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DB.DBA.VHOST_REMOVE (
